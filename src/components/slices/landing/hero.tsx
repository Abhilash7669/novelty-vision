...
export default function Hero({}: Props) {
  return (
    <section className="flex flex-col items-center justify-start space-y-10">
        <Chip>
            Introducing Halo, how can DOOH benefit you?
        </Chip>
        <div className="flex flex-col items-center space-y-6">
            <h1 className="font-neue-montreal font-medium text-white text-5xl max-w-[24ch] text-center">
